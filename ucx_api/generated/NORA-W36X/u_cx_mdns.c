...
{
    uCxAtClient_t *pAtClient = puCxHandle->pAtClient;
    // Format: AT+UWMDNSC=<index>,"<service_name>","<service_type>",<port>
    // Format string: "d" for index, "ss" for two quoted strings, "d" for port
    return uCxAtClientExecSimpleCmdF(pAtClient, "AT+UWMDNSC=", "dssd", 
                                      index, service_name, service_type, port, 
