...
bool uCxBluetoothGetExtendedAdvertiseDataBegin(uCxHandle_t * puCxHandle, int32_t index, uCxBtGetExtendedAdvertiseData_t * pBtGetExtendedAdvertiseDataRsp)
{
    ...
    ret = uCxAtClientCmdGetRspParamsF(pAtClient, "+UBTADE:", NULL, NULL, "dh", &pBtGetExtendedAdvertiseDataRsp->index, &pBtGetExtendedAdvertiseDataRsp->adv_data, U_CX_AT_UTIL_PARAM_LAST);
    return ret >= 0;
}
